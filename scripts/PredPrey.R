...
l2 = Pars$a0 + (Pars$a1 + Pars$a2*15)*seqM + Pars$a3*15
...
quartz(height = 6, width = 7)
par(mar=c(6,6,2,1))	
plot(MPred,MPrey,pch=19,cex.axis = 1.25, cex.lab = 1.5, xlab = "Predator size", ylab = "Prey size",col = rgb(0, 0, 0, alpha = 0.05))
lines(seqM,l1, col = "darkred", lwd = 2)
